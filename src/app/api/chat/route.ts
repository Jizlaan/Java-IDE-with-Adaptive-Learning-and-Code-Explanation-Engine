...
export async function POST(req: Request) {
  try {
    ...
    const systemPromptMessage = {
      role: "system",
      content: `You are a helpful and highly skilled conversational coding assistant integrated directly into a Java IDE. 
...
If they just ask follow-up questions, answer them intelligently based on the past conversation.`
    ...
    const conversation = [systemPromptMessage, ...messages];
